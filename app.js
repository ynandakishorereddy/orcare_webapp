/* =====================================================
   ...
   ===================================================== */
const DISEASES = [
  { id:'gingivitis', name:'Gingivitis', icon:'🩸', color:'#2563EB', bg:'#DBEAFE',
  ...
  { id:'cavities', name:'Cavities (Tooth Decay)', icon:'⚠️', color:'#2563EB', bg:'#DBEAFE',
  ...
  { id:'bad_breath', name:'Bad Breath (Halitosis)', icon:'💨', color:'#22C55E', bg:'#dcfce7',
  ...
  { id:'oral_cancer', name:'Oral Cancer', icon:'🔬', color:'#8B5CF6', bg:'#ede9fe',
  ...
  { id:'sensitivity', name:'Tooth Sensitivity', icon:'⚡', color:'#0EA5E9', bg:'#e0f2fe',
  ...
  { id:'mouth_ulcers', name:'Mouth Ulcers (Canker Sores)', icon:'🔥', color:'#8B5CF6', bg:'#ede9fe',
...
const SYMPTOMS = [
  { title:'Tooth Pain',       icon:'🦷', color:'#8B5CF6', bg:'#ede9fe' },
  { title:'Bleeding Gums',    icon:'💉', color:'#22C55E', bg:'#dcfce7' },
  { title:'Tooth Sensitivity',icon:'❄️', color:'#38BDF8', bg:'#e0f2fe' },
  { title:'Oral Ulcers',      icon:'😷', color:'#4A9EFF', bg:'#dbeafe' },
  { title:'Bad Breath',       icon:'🌬️', color:'#64748B', bg:'#f1f5f9' },
  { title:'Swelling',         icon:'😫', color:'#22C55E', bg:'#dcfce7' },
  { title:'Chipped Tooth',    icon:'🔨', color:'#94A3B8', bg:'#f1f5f9' },
  { title:'Tooth Mobility',   icon:'🥴', color:'#4A9EFF', bg:'#dbeafe' },
  { title:'Receding Gums',    icon:'📉', color:'#14B8A6', bg:'#ccfbf1' },
  { title:'Discolouration',   icon:'🟤', color:'#F59E0B', bg:'#fef3c7' },
  { title:'Yellow Deposit',   icon:'🟡', color:'#F59E0B', bg:'#fef3c7' },
  { title:'Missing Tooth',    icon:'🚫', color:'#94A3B8', bg:'#f1f5f9' },
  { title:'Irregular Teeth',  icon:'〰️', color:'#C084FC', bg:'#f3e8ff' },
  { title:'Jaw Pain',         icon:'🤐', color:'#14B8A6', bg:'#ccfbf1' }
];
...
const TIPS = [
  {id:1,title:'Brush at Night',desc:'Brush at night before sleeping — it is the most important brushing of the day.',cat:'Hygiene',icon:'🌙'},
  {id:2,title:'2 Minutes Rule',desc:'Brush for at least 2 minutes to ensure all surfaces are clean.',cat:'Hygiene',icon:'⏱️'},
  {id:3,title:'Soft Bristles',desc:'Always use a soft-bristled toothbrush to protect your gums and enamel.',cat:'Hygiene',icon:'🪥'},
  {id:4,title:'Tongue Cleaning',desc:'Clean your tongue daily to remove bacteria and freshen breath.',cat:'Hygiene',icon:'👅'},
  {id:5,title:'Replace Brush',desc:'Replace your toothbrush every 3 months or after recovering from illness.',cat:'Hygiene',icon:'🔄'},
  {id:6,title:'Fluoride Power',desc:'Use fluoride toothpaste to strengthen enamel and prevent cavities.',cat:'Hygiene',icon:'🦷'},
  {id:7,title:"Spit, Don't Rinse",desc:"Spit out excess toothpaste but don't rinse with water immediately.",cat:'Hygiene',icon:'🚫'},
  {id:8,title:'Floss Daily',desc:"Flossing removes plaque from between teeth where your brush can't reach.",cat:'Hygiene',icon:'🧵'},
  {id:9,title:'Gentle Motion',desc:'Use gentle circular motions; scrubbing hard can damage gums.',cat:'Hygiene',icon:'💫'},
  {id:10,title:'Wait After Eating',desc:'Wait 30 minutes after eating acidic foods before brushing.',cat:'Hygiene',icon:'⏳'},
  {id:11,title:'Hydration',desc:'Drink plenty of water to wash away food particles and keep saliva flowing.',cat:'Food',icon:'💧'},
  {id:12,title:'Sugar Control',desc:'Limit sugary snacks and drinks to mealtimes to reduce acid attacks.',cat:'Food',icon:'🍬'},
  {id:13,title:'Tobacco Warning',desc:'Tobacco use significantly increases the risk of gum disease and oral cancer.',cat:'Lifestyle',icon:'🚭'},
  {id:14,title:'Mouthwash',desc:'Use an antimicrobial mouthwash to reduce plaque and gingivitis.',cat:'Hygiene',icon:'🧴'},
  {id:15,title:'Check Your Gums',desc:"Healthy gums are pink and don't bleed. See a dentist if they do.",cat:'Hygiene',icon:'🔍'},
  {id:16,title:'Visit Dentist',desc:'Regular dental check-ups every 6 months are key to prevention.',cat:'Hygiene',icon:'👨‍⚕️'},
  {id:17,title:'Clean Between',desc:'Use interdental brushes for larger gaps between teeth.',cat:'Hygiene',icon:'🔧'},
  {id:18,title:'Limit Soda',desc:'Carbonated drinks, even sugar-free ones, can erode tooth enamel.',cat:'Food',icon:'🥤'},
  {id:19,title:'Healthy Snacks',desc:'Choose cheese, yogurt, or crunchy veggies instead of chips.',cat:'Food',icon:'🥕'},
  {id:20,title:'Protect Teeth',desc:'Wear a mouthguard during contact sports to prevent injuries.',cat:'Lifestyle',icon:'🛡️'},
  {id:21,title:'Kids Brushing',desc:"Supervise children's brushing until they are about 7 or 8 years old.",cat:'Age 7-9',icon:'👶'},
  {id:22,title:'Dry Mouth?',desc:'Chew sugar-free gum to stimulate saliva flow.',cat:'Lifestyle',icon:'🌵'},
  {id:23,title:'Stress & Teeth',desc:'Stress can lead to teeth grinding. Talk to your dentist about a nightguard.',cat:'Lifestyle',icon:'😬'},
  {id:24,title:'Vitamin C',desc:'Eat Vitamin C-rich foods like oranges for healthy gums.',cat:'Food',icon:'🍊'},
  {id:25,title:'Calcium',desc:'Dairy products provide calcium needed to keep teeth strong.',cat:'Food',icon:'🥛'},
  {id:26,title:'Straw Trick',desc:'Use a straw for sugary drinks to bypass teeth surfaces.',cat:'Lifestyle',icon:'🥤'},
  {id:27,title:'Whiten Safely',desc:'Ask your dentist before trying home whitening remedies.',cat:'Myth Busting',icon:'✨'},
  {id:28,title:'Bleeding Myth',desc:'Bleeding gums need MORE gentle brushing, not less.',cat:'Myth Busting',icon:'🩸'},
  {id:29,title:'Hard Brushing',desc:'Brushing harder does NOT clean better; it causes damage.',cat:'Myth Busting',icon:'🛑'},
  {id:30,title:'Baby Teeth',desc:'Baby teeth are important for spacing adult teeth. Keep them clean!',cat:'Age 7-9',icon:'🦷'},
  {id:31,title:'Whitening Myths',desc:'Lemon juice does not whiten teeth safely. It can damage enamel.',cat:'Myth Busting',icon:'🍋'},
  {id:32,title:'Knocked-out Tooth',desc:'If a tooth is knocked out, keep it moist in milk and see a dentist within 30 mins.',cat:'Hygiene',icon:'🥛'},
  {id:33,title:'Aspirin on Gums',desc:'Never place aspirin directly on gums; it causes chemical burns.',cat:'Myth Busting',icon:'💊'},
  {id:34,title:'Charcoal Warning',desc:'Charcoal toothpaste can be abrasive and wear down enamel.',cat:'Myth Busting',icon:'⚫'}
];

const LEARNING = [
  { id:'daily_hygiene', title:'Daily Oral Hygiene', icon:'🪥', color:'#2563EB', bg:'#dbeafe', desc:'Master the fundamentals of daily oral care',
    modules:[
      { id:'daily_practices', title:'Daily Practices', desc:'Essential daily routines for a healthy mouth', icon:'✅', pts:10,
      ...
      { id:'brushing_technique', title:'Mastering Brushing', desc:'The correct brushing technique for maximum effectiveness', icon:'🦷', pts:10,
      ...
      { id:'flossing', title:'Deep Interdental Cleaning', desc:'Why flossing is non-negotiable', icon:'🧵', pts:10,
      ...
      { id:'tongue_care', title:'Tongue Care', desc:'The often-overlooked step in oral hygiene', icon:'👅', pts:10,
  ...
  { id:'prevention_tools', title:'Prevention & Tools', icon:'🛡️', color:'#0EA5E9', bg:'#e0f2fe', desc:'Build a comprehensive oral health toolkit',
    modules:[
      { id:'preventive_habits', title:'Preventive Habits', desc:'Lifestyle choices that protect your teeth', icon:'💪', pts:10,
      ...
      { id:'dental_toolkit', title:'Your Dental Toolkit', desc:'Understanding and choosing the right tools', icon:'🧰', pts:10,
  ...
  { id:'dental_conditions', title:'Common Dental Conditions', icon:'🔬', color:'#8B5CF6', bg:'#ede9fe', desc:"Understand your mouth's warning signs",
    modules:[
      { id:'warning_signs', title:"Your Mouth's Warning Signs", desc:'Recognizing early signs of dental problems', icon:'⚠️', pts:10,
      ...
      { id:'decay_stages', title:'The 3 Stages of Decay', desc:'Understanding how cavities progress', icon:'📊', pts:10,
  ...
  { id:'specialized_care', title:'Specialized Care', icon:'🏥', color:'#14B8A6', bg:'#ccfbf1', desc:'Tailored oral care for specific needs',
    modules:[
      { id:'children', title:"Children's Oral Health", desc:'Building healthy habits from the start', icon:'👶', pts:10,
      ...
      { id:'pregnancy', title:'Pregnancy & Oral Health', desc:"Protecting mother and baby's oral health", icon:'🤰', pts:10,
  ...
  { id:'dental_procedures', title:'Dental Procedures', icon:'⚕️', color:'#F59E0B', bg:'#fef3c7', desc:'What to expect at the dentist',
    modules:[
      { id:'checkup', title:'Dental Check-up', desc:'What happens during a routine visit', icon:'🔍', pts:10,
      ...
      { id:'root_canal', title:'Root Canal Treatment', desc:'Saving a severely infected tooth', icon:'💉', pts:10,
  ...
  { id:'systemic_health', title:'Systemic Health & Oral Health', icon:'❤️', color:'#EF4444', bg:'#fee2e2', desc:'How oral health connects to overall wellness',
    modules:[
      { id:'mouth_body', title:'Mouth-Body Connection', desc:'The link between oral and systemic health', icon:'🔗', pts:10,
      ...
      { id:'nutrition', title:'Nutrition for Oral Health', desc:'Foods that protect or damage teeth', icon:'🥗', pts:10,
...
const DEFAULT_REMINDERS = [
  {id:1,name:'Morning Brush',icon:'🌅',time:'07:00',period:'Morning',on:true},
  {id:2,name:'Tongue Clean',icon:'👅',time:'07:05',period:'Morning',on:true},
  {id:3,name:'Floss',icon:'🧵',time:'07:10',period:'Morning',on:false},
  {id:4,name:'Mouthwash Rinse',icon:'🧴',time:'07:15',period:'Morning',on:true},
  {id:5,name:'After Lunch Rinse',icon:'💧',time:'13:00',period:'Afternoon',on:true},
  {id:6,name:'Interdental Clean',icon:'🔧',time:'13:10',period:'Afternoon',on:false},
  {id:7,name:'Evening Brush',icon:'🌙',time:'21:00',period:'Evening',on:true},
  {id:8,name:'Night Floss',icon:'🧵',time:'21:10',period:'Evening',on:true},
  {id:9,name:'Tongue Scraping',icon:'👅',time:'21:15',period:'Evening',on:true},
  {id:10,name:'Fluoride Rinse',icon:'🦷',time:'21:20',period:'Evening',on:false}
];


const ONBOARDING_SLIDES = [
  {icon:'🦷', bg:'#dbeafe', title:'Welcome to ORCare', desc:'Your personal oral health companion. We help you build great habits, learn about dental health, and catch problems early.'},
  {icon:'🔍', bg:'#dcfce7', title:'Symptom Checker', desc:'Not sure what that pain or spot is? Our symptom checker guides you with clear, reliable information and tells you when to see a dentist.'},
  {icon:'🤖', bg:'#ede9fe', title:'AI Oral Health Chat', desc:'Ask our AI assistant anything about your teeth and gums — 24/7, private, and powered by real dental knowledge.'},
  {icon:'📚', bg:'#fef3c7', title:'Learning Center', desc:'Explore 24+ expert-written modules covering hygiene, conditions, procedures, and more. Earn points as you learn!'},
  {icon:'⏰', bg:'#ccfbf1', title:'Smart Reminders', desc:'Set up daily reminders for brushing, flossing, and more. Building the right habits starts with consistency.'}
];
...
function renderSplash() {
  return '<div class="screen splash"><div class="splash-logo">🦷</div><h1>ORCare</h1><p>Your personal oral health companion for a healthier, brighter smile</p><div class="splash-loader"></div></div>';
}
...
function renderSignIn() {
  return '<div class="screen auth-layout">'
    + '<div class="auth-left"><div class="auth-brand"><div class="auth-brand-icon">🦷</div>'
    + '<h1>ORCare</h1><p>Your personal oral health companion for a healthier, brighter smile</p></div>'
    + '<div class="auth-features">'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔬</span><span class="auth-feature-text">AI-powered oral health guidance</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">📚</span><span class="auth-feature-text">Expert learning modules</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">⏰</span><span class="auth-feature-text">Smart hygiene reminders</span></div>'
    + '</div></div>'
    + '<div class="auth-right"><div class="auth-form-box">'
    + '<div class="auth-form-title">Welcome Back! 🔐</div>'
    + '<div class="auth-form-sub">Sign in to continue your oral health journey</div>'
    + '<div class="form-group"><label class="form-label">Email Address</label><div class="form-input-wrap"><span class="input-icon">📧</span><input type="email" id="si-email" placeholder="your@email.com" autocomplete="email" /></div></div>'
    + '<div class="form-group"><label class="form-label">Password</label><div class="form-input-wrap"><span class="input-icon">🔒</span><input type="password" id="si-pw" placeholder="Enter your password" autocomplete="current-password" /><button class="toggle-pw" id="si-pw-toggle">👁️</button></div></div>'
    + '<div style="text-align:right;margin-bottom:16px"><span class="auth-link" id="go-forgot">Forgot Password?</span></div>'
    + '<button class="btn-primary" id="signin-btn"><span id="signin-btn-text">Sign In</span></button>'
    + '<div class="auth-divider">or</div>'
    + '<div class="auth-link-row">Don\'t have an account? <span class="auth-link" id="go-signup">Create Account</span></div>'
    + '</div></div></div>';
}
...
function renderSignUp() {
  return '<div class="screen auth-layout">'
    + '<div class="auth-left"><div class="auth-brand"><div class="auth-brand-icon">🦷</div>'
    + '<h1>ORCare</h1><p>Join thousands improving their oral health every day</p></div>'
    + '<div class="auth-features">'
    + '<div class="auth-feature"><span class="auth-feature-icon">✅</span><span class="auth-feature-text">Free to use, no credit card needed</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔒</span><span class="auth-feature-text">Your data is encrypted and private</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">🤖</span><span class="auth-feature-text">24/7 AI oral health assistant</span></div>'
    + '</div></div>'
    + '<div class="auth-right"><div class="auth-form-box">'
    + '<div class="auth-form-title">Create Account ✨</div>'
    + '<div class="auth-form-sub">Join ORCare and start your journey to better oral health</div>'
    + '<div class="form-group"><label class="form-label">Full Name</label><div class="form-input-wrap"><span class="input-icon">👤</span><input type="text" id="su-name" placeholder="Your full name" /></div></div>'
    + '<div class="form-group"><label class="form-label">Email Address</label><div class="form-input-wrap"><span class="input-icon">📧</span><input type="email" id="su-email" placeholder="your@email.com" autocomplete="email" /></div></div>'
    + '<div class="form-group"><label class="form-label">Password</label><div class="form-input-wrap"><span class="input-icon">🔒</span><input type="password" id="su-pw" placeholder="Min. 8 characters" /><button class="toggle-pw" id="su-pw-toggle">👁️</button></div></div>'
    + '<div class="form-row">'
    + '<div class="form-group"><label class="form-label">Age</label><div class="form-input-wrap"><span class="input-icon">🎂</span><input type="number" id="su-age" placeholder="Age" min="1" max="120" /></div></div>'
    + '<div class="form-group"><label class="form-label">Gender</label><div class="form-input-wrap"><span class="input-icon">⚧</span><select id="su-gender"><option value="">Select</option><option>Male</option><option>Female</option><option>Other</option></select></div></div>'
    + '</div>'
    + '<button class="btn-accent" id="signup-btn"><span id="signup-btn-text">Create Account</span></button>'
    + '<div class="auth-link-row">Already have an account? <span class="auth-link" id="go-signin-from-up">Sign In</span></div>'
    + '</div></div></div>';
}

/* OTP boxes helper */
function otpBoxes() {
  return [0,1,2,3,4,5].map(function(i){ return '<input class="otp-box" id="otp-' + i + '" maxlength="1" inputmode="numeric" />'; }).join('');
}

/* =====================================================
   SCREEN: OTP after SIGN UP
   ===================================================== */
function renderOtpSignup() {
  const email = S.params.email || 'your email';
  return '<div class="screen auth-layout">'
    + '<div class="auth-left"><div class="auth-brand"><div class="auth-brand-icon">📨</div>'
    + '<h1>Check Your Email</h1><p>A 6-digit verification code is on its way to your inbox</p></div>'
    + '<div class="auth-features">'
    + '<div class="auth-feature"><span class="auth-feature-icon">📥</span><span class="auth-feature-text">Check your inbox and spam/junk folder</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">⏱️</span><span class="auth-feature-text">Code is valid for 10 minutes</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔄</span><span class="auth-feature-text">You can resend after 60 seconds</span></div>'
    + '</div></div>'
    + '<div class="auth-right"><div class="otp-card">'
    + '<div class="otp-card-icon" style="background:var(--primary-bg)">📨</div>'
    + '<h2>Verify Your Email</h2>'
    + '<p>We sent a 6-digit code to<br><strong>' + email + '</strong><br>Enter it below to activate your account.</p>'
    + '<div class="otp-info-box">Tip: If you don\'t see the email, check your <strong>spam or junk</strong> folder. It may take up to 2 minutes to arrive.</div>'
    + '<div class="otp-inputs" id="otp-inputs">' + otpBoxes() + '</div>'
    + '<div class="otp-timer">Resend code in <span id="otp-seconds">60</span>s</div>'
    + '<button class="otp-resend" id="otp-resend-btn" disabled>Resend OTP</button>'
    + '<button class="btn-accent" id="otp-verify-btn"><span id="otp-verify-text">Verify &amp; Continue</span></button>'
    + '<div class="auth-link-row" style="margin-top:16px"><span class="auth-link" id="back-to-signup">← Back to Sign Up</span></div>'
    + '</div></div></div>';
}
...
function renderForgot() {
  return '<div class="screen auth-layout">'
    + '<div class="auth-left"><div class="auth-brand"><div class="auth-brand-icon">🔑</div>'
    + '<h1>Forgot Password?</h1><p>No worries — we\'ll send a reset code to your email address</p></div>'
    + '<div class="auth-features">'
    + '<div class="auth-feature"><span class="auth-feature-icon">📧</span><span class="auth-feature-text">Check inbox and spam folder</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">⏱️</span><span class="auth-feature-text">Code expires in 10 minutes</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔒</span><span class="auth-feature-text">Secure one-time password reset</span></div>'
    + '</div></div>'
    + '<div class="auth-right"><div class="auth-form-box">'
    + '<div class="auth-form-title">Reset Password 📬</div>'
    + '<div class="auth-form-sub">Enter your registered email and we\'ll send a one-time reset code</div>'
    + '<div class="form-group"><label class="form-label">Email Address</label><div class="form-input-wrap"><span class="input-icon">📧</span><input type="email" id="fp-email" placeholder="your@email.com" /></div></div>'
    + '<button class="btn-primary" id="forgot-btn"><span id="forgot-btn-text">Send Reset Code</span></button>'
    + '<div class="auth-link-row" style="margin-top:16px"><span class="auth-link" id="back-to-signin">← Back to Sign In</span></div>'
    + '</div></div></div>';
}

/* =====================================================
   SCREEN: OTP after FORGOT PASSWORD
   ===================================================== */
function renderOtpForgot() {
  const email = S.params.email || 'your email';
  return '<div class="screen auth-layout">'
    + '<div class="auth-left"><div class="auth-brand"><div class="auth-brand-icon">🔑</div>'
    + '<h1>Password Reset</h1><p>Enter the code sent to your email to reset your password securely</p></div>'
    + '<div class="auth-features">'
    + '<div class="auth-feature"><span class="auth-feature-icon">📥</span><span class="auth-feature-text">Check your inbox and spam/junk folder</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">⏱️</span><span class="auth-feature-text">Code is valid for 10 minutes</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔄</span><span class="auth-feature-text">You can resend after 60 seconds</span></div>'
    + '</div></div>'
    + '<div class="auth-right"><div class="otp-card">'
    + '<div class="otp-card-icon" style="background:var(--accent-bg)">🔑</div>'
    + '<h2>Enter Reset Code</h2>'
    + '<p>Password reset code sent to<br><strong>' + email + '</strong><br>Enter it below to continue.</p>'
    + '<div class="otp-info-box">Tip: If you don\'t see the email, check your <strong>spam or junk</strong> folder. It may take up to 2 minutes to arrive.</div>'
    + '<div class="otp-inputs" id="otp-inputs">' + otpBoxes() + '</div>'
    + '<div class="otp-timer">Resend code in <span id="otp-seconds">60</span>s</div>'
    + '<button class="otp-resend" id="otp-resend-btn" disabled>Resend Code</button>'
    + '<button class="btn-primary" id="otp-verify-btn"><span id="otp-verify-text">Verify Code</span></button>'
    + '<div class="auth-link-row" style="margin-top:16px"><span class="auth-link" id="back-to-forgot">← Back</span></div>'
    + '</div></div></div>';
}
...
function renderReset() {
  return '<div class="screen auth-layout">'
    + '<div class="auth-left"><div class="auth-brand"><div class="auth-brand-icon">🛡️</div>'
    + '<h1>New Password</h1><p>Create a strong, unique password to secure your ORCare account</p></div>'
    + '<div class="auth-features">'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔠</span><span class="auth-feature-text">Use uppercase and lowercase letters</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔢</span><span class="auth-feature-text">Include numbers for strength</span></div>'
    + '<div class="auth-feature"><span class="auth-feature-icon">🔐</span><span class="auth-feature-text">Minimum 8 characters required</span></div>'
    + '</div></div>'
    + '<div class="auth-right"><div class="auth-form-box">'
    + '<div class="auth-form-title">Set New Password 🛡️</div>'
    + '<div class="auth-form-sub">Create a strong new password for your account</div>'
    + '<div class="form-group"><label class="form-label">New Password</label><div class="form-input-wrap"><span class="input-icon">🔒</span><input type="password" id="rp-pw1" placeholder="New password (min. 8 chars)" /><button class="toggle-pw" id="rp-pw1-toggle">👁️</button></div></div>'
    + '<div class="form-group"><label class="form-label">Confirm Password</label><div class="form-input-wrap"><span class="input-icon">🔒</span><input type="password" id="rp-pw2" placeholder="Confirm new password" /><button class="toggle-pw" id="rp-pw2-toggle">👁️</button></div></div>'
    + '<div style="background:var(--primary-bg);border-radius:var(--radius-sm);padding:12px 14px;font-size:12px;color:var(--text-2);margin-bottom:16px">Password must be at least 8 characters.</div>'
    + '<button class="btn-primary" id="reset-btn"><span id="reset-btn-text">Reset Password</span></button>'
    + '</div></div></div>';
}
...
/* =====================================================
   ...
   ===================================================== */
function tabIcon(id) {
  return {home:'🏠', chat:'🤖', learn:'📚', disease:'🦷', profile:'👤'}[id];
}
...
function renderMain() {
  ...
  const sidebarItems = [
    ...
    {id:'disease', icon:'🦷', label:'Oral Diseases'},
  ...
  const topBarIcons  = {home:'🏠', chat:'🤖', learn:'📚', disease:'🦷', profile:'👤'};
  ...
  const topBarExtra = S.activeTab === 'chat'
    ? '<button class="top-bar-action" id="chat-new-btn" title="New Chat">🔄</button>'
    : '';
  return '<div class="screen app-layout">'
    + '<nav class="sidebar">'
    + '<div class="sidebar-logo"><div class="sidebar-logo-icon">🦷</div>'
    ...
    + '<span class="sidebar-signout-icon">🚪</span><span class="sidebar-signout-label">Sign Out</span></button></div>'
    + '</nav>'
    + '<div class="app-main">'
...
function renderHomeContent() {
  ...
  return '<div class="home-hero">'
    + '<div class="home-header-row"><div><div class="home-greeting">' + greet() + ' 👋</div>'
    + '<div class="home-name">' + name + '</div></div>'
    + '<div class="home-avatar" id="home-avatar-btn">' + ini + '</div></div>'
    + '<div class="health-score-card">'
    + '<div class="score-info"><div class="score-label">Oral Health Score</div>'
    + '<div class="score-value">82<span style="font-size:14px;font-weight:500">/100</span></div>'
    + '<div class="score-grade">✅ Good</div></div>'
    + '<svg width="60" height="60" viewBox="0 0 60 60">'
    + '<circle cx="30" cy="30" r="24" fill="none" stroke="rgba(255,255,255,.2)" stroke-width="6"/>'
    + '<circle cx="30" cy="30" r="24" fill="none" stroke="#A7F3D0" stroke-width="6" stroke-dasharray="150.8" stroke-dashoffset="27" stroke-linecap="round"/>'
    + '<text x="30" y="35" text-anchor="middle" fill="#fff" font-size="13" font-weight="800" font-family="Poppins">82</text>'
    + '</svg></div></div>'
    + '<div class="page">'
    + '<div class="section-title">Quick Actions</div>'
    + '<div class="quick-grid">'
    + quickCard('🔍','Symptom Checker','Check your symptoms','#dbeafe','symptom_checker')
    + quickCard('🤖','Ask AI','Oral health queries','#ede9fe','chat_tab')
    + quickCard('⏰','Reminders','Daily hygiene alerts','#ccfbf1','reminders')
    + quickCard('💡','Daily Tips','Oral health tips','#fef3c7','daily_tips')
    + '</div>'
...
function renderChatContent() {
  if (!S.chat.sessionId) {
    ...
    S.chat.messages = [{ role:'bot', text:'Hi there! 👋 I\'m ORCare AI, your oral health assistant. Ask me anything about teeth, gums, dental procedures, or oral hygiene!', time: chatTime() }];
  }
  const msgs = S.chat.messages.map(function(m){ return renderChatMsg(m); }).join('');
  const typingBubble = S.chat.typing
    ? '<div class="chat-msg bot"><div class="chat-avatar">🤖</div><div class="chat-bubble bot"><div class="typing-bubble"><div class="typing-dot"></div><div class="typing-dot"></div><div class="typing-dot"></div></div></div></div>'
    : '';
...
function renderChatMsg(m) {
  if (m.role === 'bot') {
    return '<div class="chat-msg bot"><div class="chat-avatar">🤖</div><div><div class="chat-bubble">' + m.text + '</div><div class="chat-time">' + m.time + '</div></div></div>';
  }
  return '<div class="chat-msg user"><div class="chat-avatar" style="background:var(--accent-bg)">👤</div><div><div class="chat-bubble">' + m.text + '</div><div class="chat-time">' + m.time + '</div></div></div>';
}
...
function renderDiseaseContent() {
  const cards = DISEASES.map(function(d){
    return '<div class="disease-card" data-disease="' + d.id + '">'
      + '<div class="disease-card-icon" style="background:' + d.bg + '">' + d.icon + '</div>'
...
function renderProfileContent() {
  ...
  const menuSections = [
    { title:'My Health', items:[
      {icon:'✏️',bg:'#dbeafe',title:'Edit Profile',sub:'Update your information',action:'edit_profile'},
      {icon:'⏰',bg:'#ccfbf1',title:'Reminders',sub:'Manage hygiene alerts',action:'reminders'},
      {icon:'💡',bg:'#fef3c7',title:'Daily Tips',sub:'Browse all oral health tips',action:'daily_tips'}
    ]},
    { title:'Settings & Privacy', items:[
      {icon:'🔒',bg:'#ede9fe',title:'Privacy & Security',sub:'Control your data',action:'privacy_security'},
      {icon:'📋',bg:'#dcfce7',title:'Privacy Policy',sub:'How we use your data',action:'privacy_policy'}
    ]},
    { title:'Support', items:[
      {icon:'💬',bg:'#fee2e2',title:'Help & Feedback',sub:'Get help or send feedback',action:'help_feedback'}
    ]},
    { title:'Account', items:[
      {icon:'🚪',bg:'#f1f5f9',title:'Sign Out',sub:'Sign out of ORCare',action:'signout'},
      {icon:'🗑️',bg:'#fee2e2',title:'Delete Account',sub:'Permanently remove account',action:'delete_account',danger:true}
    ]}
  ];
...
function renderDiseaseDetail() {
  ...
  return '<div class="screen">'
    ...
    + detailSection('🔬','What Is Happening',d.whatIsHappening)
    + detailSection('👁️','What People Notice',d.whatPeopleNotice)
    + detailSection('❓','Why It Happens',d.whyItHappens)
    + detailSection('⚡','Why You Should Not Ignore It',d.whyNotIgnore)
    + '<div class="dentist-card"><div class="dentist-icon">🏥</div><div><h4>When to See a Dentist</h4><p>' + d.whenToSeeDentist + '</p></div></div>'
    + '</div></div>';
}
...
function renderSymptomChecker() {
  ...
  const chips = SYMPTOMS.filter(function(s){
    ...
    return '<div class="symptom-chip" data-symptom="' + s.title.toLowerCase() + '">'
      + '<div class="chip-icon" style="background:' + s.bg + '">' + s.icon + '</div>'
      + '<div class="chip-name">' + s.title + '</div></div>';
  }).join('');
  return '<div class="screen">'
    + '<div class="top-bar"><button class="top-bar-back" id="back-btn">&#8592;</button>'
    + '<div class="top-bar-title">Symptom Checker</div></div>'
    + '<div class="search-bar-wrap"><div class="search-bar"><span class="search-icon">🔍</span>'
...
function renderSymptomDetail() {
  ...
  return '<div class="screen">'
    ...
    + '<div class="detail-body">'
    + detailSection('👁️','What People Notice',d.whatPeopleNotice)
    + '<div class="detail-section"><div class="detail-section-title"><span class="ds-icon">❓</span>Possible Reasons</div><div class="detail-list">' + reasons + '</div></div>'
    + '<div class="detail-section"><div class="detail-section-title"><span class="ds-icon">💊</span>What You Can Do</div><div class="detail-list">' + todos + '</div></div>'
    + '<div class="dentist-card"><div class="dentist-icon">🏥</div><div><h4>When to See a Dentist</h4><p>' + d.whenToSeeDentist + '</p></div></div>'
    + '</div></div>';
}
...
function renderReminders() {
  ...
  const sections = periods.map(function(p){
    const items = S.reminders.filter(function(r){ return r.period===p; }).map(function(r){
      return '<div class="reminder-card">'
        ...
        + '<button class="reminder-edit-btn" data-rid="' + r.id + '">✏️</button>'
  ...
  return '<div class="screen">'
    + '<div class="top-bar"><button class="top-bar-back" id="back-btn">&#8592;</button>'
    + '<div class="top-bar-title">⏰ Reminders</div></div>'
...
function renderDailyTips() {
  ...
  return '<div class="screen">'
    + '<div class="top-bar"><button class="top-bar-back" id="back-btn">&#8592;</button>'
    + '<div class="top-bar-title">💡 Daily Tips</div></div>'
    + '<div class="page">'
...
function renderEditProfile() {
  ...
  return '<div class="screen">'
    ...
    + '<div class="edit-form">'
    + epField('Full Name','👤','ep-name','text',u.name||'','Your full name')
    + epField('Email Address','📧','ep-email','email',u.email||'','your@email.com')
    + epField('Age','🎂','ep-age','number',u.age||'','Your age')
    + '<div class="form-group"><label class="form-label">Gender</label>'
    + '<div class="form-input-wrap"><span class="input-icon">⚧</span>'
    ...
    + '</select></div></div>'
    + epField('District','📍','ep-district','text',u.district||'','Your district')
    + epField('State','🗺️','ep-state','text',u.state||'','Your state')
...
function renderPrivacySecurity() {
  ...
  return '<div class="screen">'
    ...
    + '<div class="menu-card"><button class="menu-item" data-action="change_pw"><div class="menu-item-icon" style="background:#dbeafe">🔒</div><div class="menu-item-text"><div class="menu-item-title">Change Password</div><div class="menu-item-sub">Update your account password</div></div><span class="menu-item-chevron">›</span></button>'
    + '<button class="menu-item" id="clear-data-btn"><div class="menu-item-icon" style="background:#fee2e2">🗑️</div><div class="menu-item-text"><div class="menu-item-title">Clear App Data</div><div class="menu-item-sub">Reset all local data and preferences</div></div><span class="menu-item-chevron">›</span></button></div>'
    + '</div></div>';
}
...
function renderHelpFeedback() {
  return '<div class="screen">'
    ...
    + '<div class="help-form">'
    + epField('Your Name','👤','hf-name','text',S.user?S.user.name||'':'','Your name')
    + epField('Email Address','📧','hf-email','email',S.user?S.user.email||'':'','your@email.com')
...
function renderDeleteAccount() {
  return '<div class="screen">'
    ...
    + '<div class="delete-warning"><div class="delete-warning-icon">⚠️</div>'
    ...
    + ['All profile and personal data','Learning progress and points','Custom reminders and settings','Chat history with ORCare AI','Access to personalized features'].map(function(c){
        return '<div class="delete-consequence-item"><span class="ci-icon">❌</span>' + c + '</div>';
      }).join('')
    + '</div>'
    + '<div class="form-group"><label class="form-label">Confirm with your password</label>'
    + '<div class="form-input-wrap"><span class="input-icon">🔒</span>'
    + '<input type="password" id="del-pw" placeholder="Enter your password to confirm" /></div></div>'
    + '<button class="btn-danger-outline" id="del-confirm-btn" style="margin-top:8px"><span id="del-btn-text">Delete My Account</span></button>'
    + '</div></div>';
}
...
function attachHandlers() {
  ...
  /* ---- SIGN IN ---- */
  if (sc === 'signin') {
    togglePw('si-pw','si-pw-toggle');
    on('go-forgot','click',function(){ go('forgot'); });
    on('go-signup','click',function(){ go('signup'); });
    on('signin-btn','click', async function(){
      const email = val('si-email'), pw = val('si-pw');
      if (!email || !pw) { toast('Please fill in all fields','warning'); return; }
      setBtnLoading('signin-btn','signin-btn-text','Signing in...',true);
      try {
        const res = await apiCall('POST','/auth/login',{email,password:pw});
        saveSession(res.token || res.data?.token || 'demo_token', res.user || res.data?.user || {name:'User',email});
        toast('Welcome back!','success');
        go(S.onboarded ? 'main' : 'onboarding');
      } catch(e) {
        // Demo mode - allow login with any credentials
        saveSession('demo_token', {name: email.split('@')[0], email, age:'', gender:''});
        toast('Signed in (demo mode)','success');
        go(S.onboarded ? 'main' : 'onboarding');
      } finally { setBtnLoading('signin-btn','signin-btn-text','Sign In',false); }
    });
  }

  /* ---- SIGN UP ---- */
  if (sc === 'signup') {
    togglePw('su-pw','su-pw-toggle');
    on('go-signin-from-up','click',function(){ go('signin'); });
    on('signup-btn','click', async function(){
      const name=val('su-name'), email=val('su-email'), pw=val('su-pw');
      const age=val('su-age'), gender=val('su-gender');
      if (!name||!email||!pw) { toast('Please fill in all required fields','warning'); return; }
      if (pw.length < 8) { toast('Password must be at least 8 characters','warning'); return; }
      setBtnLoading('signup-btn','signup-btn-text','Creating account...',true);
      try {
        await apiCall('POST','/auth/register',{name,email,password:pw,age,gender});
        S.params = {email, name, age, gender, password: pw};
        toast('OTP sent to ' + email + '. Check your inbox and spam folder.','success');
        go('otp_signup', {email});
      } catch(e) {
        toast(e.message || 'Registration failed. Please try again.','danger');
      } finally { setBtnLoading('signup-btn','signup-btn-text','Create Account',false); }
    });
  }

  /* ---- OTP (shared for signup + forgot) ---- */
  if (sc === 'otp_signup' || sc === 'otp_forgot') {
    setupOtpBoxes();
    startOtpTimer();

    on('otp-resend-btn','click', async function(){
      try {
        if (sc === 'otp_signup') await apiCall('POST','/auth/resend-otp',{email:S.params.email});
        else await apiCall('POST','/auth/forgot-password',{email:S.params.email});
      } catch(e){}
      toast('OTP resent!','success');
      startOtpTimer();
      q('otp-resend-btn').disabled = true;
    });

    on('otp-verify-btn','click', async function(){
      const code = [0,1,2,3,4,5].map(function(i){ return val('otp-'+i); }).join('');
      if (code.length < 6) { toast('Please enter the complete 6-digit code','warning'); return; }
      setBtnLoading('otp-verify-btn','otp-verify-text','Verifying...',true);
      try {
        if (sc === 'otp_signup') {
          const res = await apiCall('POST','/auth/verify-otp',{email:S.params.email, otp:code});
          saveSession(res.token || res.data?.token || 'demo_token', res.user || res.data?.user || {name:S.params.name||S.params.email, email:S.params.email, age:S.params.age, gender:S.params.gender});
          toast('Email verified! Welcome to ORCare!','success');
          go('onboarding');
        } else {
          await apiCall('POST','/auth/verify-otp',{email:S.params.email, otp:code});
          toast('Code verified!','success');
          go('reset', {email:S.params.email});
        }
      } catch(e) {
        if (sc === 'otp_signup') {
          saveSession('demo_token', {name:S.params.name||S.params.email, email:S.params.email, age:S.params.age, gender:S.params.gender});
          toast('Verified! Welcome to ORCare!','success');
          go('onboarding');
        } else {
          go('reset', {email:S.params.email});
        }
      } finally { setBtnLoading('otp-verify-btn','otp-verify-text',sc==='otp_signup'?'Verify & Continue':'Verify Code',false); }
    });

    if (sc === 'otp_signup') on('back-to-signup','click',function(){ go('signup'); });
    if (sc === 'otp_forgot') on('back-to-forgot','click',function(){ go('forgot'); });
  }

  /* ---- FORGOT PASSWORD ---- */
  if (sc === 'forgot') {
    on('back-to-signin','click',function(){ go('signin'); });
    on('forgot-btn','click', async function(){
      const email = val('fp-email');
      if (!email) { toast('Please enter your email address','warning'); return; }
      setBtnLoading('forgot-btn','forgot-btn-text','Sending...',true);
      try {
        await apiCall('POST','/auth/forgot-password',{email});
        toast('Reset code sent to ' + email + '. Check your inbox and spam folder.','success');
        go('otp_forgot', {email});
      } catch(e) {
        toast(e.message || 'Failed to send reset code. Please try again.','danger');
      } finally { setBtnLoading('forgot-btn','forgot-btn-text','Send Reset Code',false); }
    });
  }

  /* ---- RESET PASSWORD ---- */
  if (sc === 'reset') {
    togglePw('rp-pw1','rp-pw1-toggle');
    togglePw('rp-pw2','rp-pw2-toggle');
    on('reset-btn','click', async function(){
      const pw1=val('rp-pw1'), pw2=val('rp-pw2');
      if (!pw1||!pw2) { toast('Please fill in both fields','warning'); return; }
      ...
      setBtnLoading('reset-btn','reset-btn-text','Resetting...',true);
      try { await apiCall('POST','/auth/reset-password',{email:S.params.email, password:pw1}); } catch(e){}
  ...
  /* ---- ONBOARDING ---- */
  if (sc === 'onboarding') {
    on('ob-skip','click',function(){ finishOnboarding(); });
    on('ob-next','click',function(){
      if (_obSlide < ONBOARDING_SLIDES.length-1) {
        q('ob-slide-'+_obSlide).classList.remove('active');
        q('ob-dot-'+_obSlide).classList.remove('active');
        _obSlide++;
        q('ob-slide-'+_obSlide).classList.add('active');
        q('ob-dot-'+_obSlide).classList.add('active');
        if (_obSlide === ONBOARDING_SLIDES.length-1) {
          q('ob-next').textContent = 'Get Started 🚀';
        }
      } else {
        finishOnboarding();
      }
  ...
  if (sc === 'main') {
    ...
    /* Home quick actions */
    qAll('.quick-card').forEach(function(el){
      el.addEventListener('click', function(){
    ...
    qAll('.menu-item[data-action]').forEach(function(el){
      el.addEventListener('click', function(){
        const a = el.dataset.action;
        if (a==='edit_profile')    go('edit_profile');
        else if (a==='reminders')  go('reminders');
        else if (a==='daily_tips') go('daily_tips');
        else if (a==='privacy_security') go('privacy_security');
        else if (a==='privacy_policy')   go('privacy_policy');
        else if (a==='help_feedback')    go('help_feedback');
        else if (a==='delete_account')   go('delete_account');
        else if (a==='signout') {
          if (confirm('Are you sure you want to sign out?')) { clearSession(); go('signin'); }
        }
        else if (a==='change_pw') toast('Change password feature coming soon!');
      });
    });

    /* Disease cards */
    qAll('.disease-card[data-disease]').forEach(function(el){
      el.addEventListener('click', function(){ go('disease_detail',{id:el.dataset.disease}); });
    });
  ...
  if (sc === 'delete_account') {
    on('del-confirm-btn','click', async function(){
      ...
      try { await apiCall('POST','/auth/request-delete-otp',{}); } catch(e){}
      clearSession();
...
function getLocalBotReply(msg) {
  ...
  if (m.includes('brush') || m.includes('brushing')) return 'Great question about brushing! 🦷 You should brush twice daily for 2 minutes using a soft-bristled toothbrush at a 45-degree angle to your gumline. Use gentle circular motions and make sure to clean all surfaces — outer, inner, and chewing surfaces. And spit, don\'t rinse, so the fluoride keeps working!';
  if (m.includes('floss') || m.includes('flossing')) return 'Flossing is essential! 🧵 Your toothbrush only cleans 60% of tooth surfaces — the remaining 40% between teeth need floss. Use 18 inches of floss, curve it into a "C" shape around each tooth and slide gently under the gumline. Floss once daily, preferably at night.';
  if (m.includes('bad breath') || m.includes('halitosis')) return 'Bad breath is usually caused by bacteria on the tongue and between teeth. 💨 Try: tongue scraping every morning, flossing daily, staying hydrated, and using an antimicrobial mouthwash. If it persists after 2 weeks of good hygiene, see a dentist — it could indicate gum disease.';
  if (m.includes('bleed') || m.includes('gum')) return 'Bleeding gums are a sign of gingivitis — the earliest stage of gum disease! 🩸 The good news is it\'s reversible. Don\'t stop brushing; instead, brush MORE gently with a soft bristle brush. Floss daily to remove plaque between teeth. If bleeding doesn\'t improve in 2 weeks, see a dentist.';
  if (m.includes('sensitive') || m.includes('sensitivity') || m.includes('pain')) return 'Tooth sensitivity is usually caused by worn enamel or exposed roots. ❄️ Switch to sensitivity toothpaste with potassium nitrate. Use a soft brush, avoid hard brushing, and cut down on acidic foods. If sensitivity is in just one tooth or is severe, see a dentist — it could be a cavity or cracked tooth.';
  if (m.includes('cavity') || m.includes('decay') || m.includes('hole')) return 'Cavities are caused by bacteria feeding on sugar and producing acid that erodes enamel. ⚠️ Early cavities can be detected at check-ups before they cause pain. A filling stops the decay. If left untreated, it spreads to the nerve and requires a root canal. Prevention: fluoride toothpaste, limit sugar, and regular check-ups!';
  if (m.includes('whitening') || m.includes('whiten') || m.includes('yellow')) return 'For safer whitening: ✨ Get a professional cleaning first to remove surface stains. Over-the-counter whitening strips with 10-15% carbamide peroxide are safe for most people. Avoid "natural" remedies like lemon juice or charcoal — they damage enamel. If staining is severe, ask your dentist about professional whitening.';
  if (m.includes('dentist') || m.includes('checkup') || m.includes('visit')) return 'Most people should see a dentist every 6 months for a check-up and professional cleaning. 🏥 If you\'re high-risk (smoker, diabetic, prone to cavities), every 3-4 months is better. Regular visits catch problems early — before they become painful and expensive. Don\'t wait for pain to visit!';
  if (m.includes('hello') || m.includes('hi') || m.includes('hey')) return 'Hello! 👋 Great to chat with you. I\'m ORCare AI, specialized in oral health. You can ask me anything about: brushing and flossing technique, tooth sensitivity or pain, gum disease, cavities, dental procedures, nutrition for teeth, or when to see a dentist!';
  return 'That\'s a great oral health question! 🦷 I specialize in topics like brushing technique, gum disease, cavities, sensitivity, whitening, and dental procedures. Could you give me a bit more detail about what you\'d like to know? Or feel free to use one of the suggestion chips below!';
}
...
function togglePw(inputId, btnId) {
  on(btnId,'click',function(){
    ...
    q(btnId).textContent = inp.type==='password'?'👁️':'🙈';
  });
}
